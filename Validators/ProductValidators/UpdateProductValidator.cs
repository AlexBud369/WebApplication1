...
public class UpdateProductValidator : AbstractValidator<UpdateProductDto>
{
    public UpdateProductValidator()
    {
        ...
        RuleFor(x => x.IsVerified)
            .NotNull().WithMessage("IsVerified is required");

        RuleFor(x => x)
            .Must(HaveValidNutrientSum).WithMessage($"Sum of protein, fat and carbs cannot exceed {AppConstants.Product.MaxNutrientSum}g per 100g of product");
    }

    private bool HaveValidNutrientSum(UpdateProductDto product)
    {
